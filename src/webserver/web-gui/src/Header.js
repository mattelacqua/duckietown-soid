  ...
  return (
    <div className="head">
      <div className="headText">
        ...
        <p>Below at right is a drag-and-drop interface for manipulating the location of cars. Further below, additional cars can be added or removed and the orientation, direction of travel, and order of intersection arrival (for calculating right-of-way) of all cars can be manipulated. In addition, the machine-learned (via reinforcement learning) decision logic to be used by the blue car can be selected.</p>
