(set-logic ALL)
(declare-fun agent0_patience_ackermann!14 () (_ BitVec 32))
(declare-fun agent1_pos_z_ackermann!22 () (_ BitVec 32))
(declare-fun agent0_turn_choice_ackermann!11 () (_ BitVec 32))
(declare-fun agent1_intersection_arrival_ackermann!0 () (_ BitVec 32))
(declare-fun agent1_pos_x_ackermann!20 () (_ BitVec 32))
(declare-fun agent0_pos_x_ackermann!4 () (_ BitVec 32))
(declare-fun agent1_step_count_ackermann!23 () (_ BitVec 32))
(declare-fun agent1_patience_ackermann!16 () (_ BitVec 32))
(declare-fun agent0_lookahead_ackermann!9 () (_ BitVec 32))
(declare-fun agent1_lookahead_ackermann!2 () (_ BitVec 32))
(declare-fun agent0_signal_choice_ackermann!10 () (_ BitVec 32))
(declare-fun agent0_pos_z_ackermann!5 () (_ BitVec 32))
(declare-fun agent1_turn_choice_ackermann!1 () (_ BitVec 32))
(declare-fun agent1_angle_ackermann!19 () (_ BitVec 32))
(declare-fun agent1_initial_direction_ackermann!18 () (_ BitVec 32))
(declare-fun agent0_intersection_arrival_ackermann!13 () (_ BitVec 32))
(declare-fun agent0_step_count_ackermann!15 () (_ BitVec 32))
(declare-fun agent0_initial_direction_ackermann!12 () (_ BitVec 32))
(declare-fun agent1_forward_step_ackermann!21 () (_ BitVec 32))
(declare-fun agent0_forward_step_ackermann!7 () (_ BitVec 32))
(declare-fun agent0_speed_ackermann!8 () (_ BitVec 32))
(declare-fun agent1_speed_ackermann!24 () (_ BitVec 32))
(declare-fun agent0_angle_ackermann!6 () (_ BitVec 32))
(declare-fun agent1_signal_choice_ackermann!3 () (_ BitVec 32))
(declare-fun __soid__will_proceed_ackermann!17 () (_ BitVec 8))
(declare-fun const_arr10 () (Array (_ BitVec 32) (_ BitVec 8)))
(assert (= #x00000000 agent0_patience_ackermann!14))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_z_ackermann!22)
            ((_ to_fp 8 24) #x403b3333))))
(assert (= #x00000002 agent0_turn_choice_ackermann!11))
(assert (= #x0000003c agent1_intersection_arrival_ackermann!0))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_z_ackermann!22)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
             (fp.sub roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
                     ((_ to_fp 8 24) #x3e3851ec)))))
(assert (= #x0000006d agent1_step_count_ackermann!23))
(assert (= #x00000000 agent1_patience_ackermann!16))
(assert (let ((a!1 ((_ to_fp 8 24)
             roundNearestTiesToEven
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
                       roundNearestTiesToEven
                       ((_ to_fp 8 24) agent0_lookahead_ackermann!9))
                     ((_ to_fp 11 53) #x4024000000000000)))))
  (not (fp.geq ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
                       a!1)))))
(assert (not (fp.geq ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
             (fp.add roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
                     ((_ to_fp 8 24) agent1_lookahead_ackermann!2)))))
(assert (= #x00000002 agent0_signal_choice_ackermann!10))
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
             ...
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
                       roundNearestTiesToEven
                       ((_ to_fp 8 24) agent0_pos_z_ackermann!5))
                     ((_ to_fp 11 53) #x3fe2b851e0000000)))))
  (= #x00000003
     ((_ fp.to_sbv 32)
       roundTowardZero
       ((_ to_fp 11 53) roundNearestTiesToEven a!1)))))
(assert (not (fp.gt ((_ to_fp 8 24) agent0_pos_z_ackermann!5)
            ((_ to_fp 8 24) #x403b3333))))
(assert (= #x00000002 agent1_turn_choice_ackermann!1))
(assert (not (fp.lt ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
            ((_ to_fp 8 24) #x00000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             ((_ to_fp 8 24) agent1_angle_ackermann!19))
...
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_z_ackermann!5)
             (fp.add roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
                     ((_ to_fp 8 24) agent1_lookahead_ackermann!2)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(assert (not (fp.lt ((_ to_fp 8 24) agent0_pos_z_ackermann!5)
            ((_ to_fp 8 24) #x00000000))))
(assert (= #x00000002 agent1_initial_direction_ackermann!18))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!2 (ite (and (fp.gt ((_ to_fp 8 24) roundNearestTiesToEven a!1)
                ...
                #x00000002)))
  (= #x00000002 a!2))))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
            ((_ to_fp 8 24) #x00000000))))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (fp.div roundNearestTiesToEven
  ...
  (= #x00000001
     ((_ fp.to_sbv 32)
       roundTowardZero
       ((_ to_fp 11 53) roundNearestTiesToEven a!1)))))
(assert (= #x0000004d agent0_intersection_arrival_ackermann!13))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
                       roundNearestTiesToEven
                       ((_ to_fp 8 24) agent1_pos_z_ackermann!22))
                     ((_ to_fp 11 53) #x3fe2b851e0000000)))))
  (= #x00000002
     ((_ fp.to_sbv 32)
       roundTowardZero
       ((_ to_fp 11 53) roundNearestTiesToEven a!1)))))
(assert (= #x0000006d agent0_step_count_ackermann!15))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
            ((_ to_fp 8 24) #x403b3333))))
(assert (= #x00000000 agent0_initial_direction_ackermann!12))
(assert (not (fp.gt ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
            ((_ to_fp 8 24) #x403b3333))))
(assert (fp.eq ((_ to_fp 8 24) agent1_angle_ackermann!19) ((_ to_fp 8 24) #x3c8b4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_x_ackermann!20) ((_ to_fp 8 24) #x3f939581)))
(assert (fp.eq ((_ to_fp 8 24) agent1_forward_step_ackermann!21)
       ((_ to_fp 8 24) #x3ee147ae)))
(assert (fp.eq ((_ to_fp 8 24) agent0_forward_step_ackermann!7)
       ((_ to_fp 8 24) #x3ee147ae)))
(assert (fp.eq ((_ to_fp 8 24) agent0_lookahead_ackermann!9)
       ((_ to_fp 8 24) #x3f15c28f)))
(assert (fp.eq ((_ to_fp 8 24) agent0_speed_ackermann!8) ((_ to_fp 8 24) #x3b03126f)))
(assert (fp.eq ((_ to_fp 8 24) agent0_pos_z_ackermann!5) ((_ to_fp 8 24) #x3feba5e3)))
(assert (fp.eq ((_ to_fp 8 24) agent1_speed_ackermann!24) ((_ to_fp 8 24) #x3e3020c5)))
(assert (fp.eq ((_ to_fp 8 24) agent0_angle_ackermann!6) ((_ to_fp 8 24) #x3fcb4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_z_ackermann!22) ((_ to_fp 8 24) #x3fcb020c)))
(assert (fp.eq ((_ to_fp 8 24) agent1_lookahead_ackermann!2)
       ((_ to_fp 8 24) #x3f15c28f)))
(assert (fp.eq ((_ to_fp 8 24) agent0_pos_x_ackermann!4) ((_ to_fp 8 24) #x3fcae148)))
(assert (fp.lt ((_ to_fp 8 24) agent0_pos_z_ackermann!5) ((_ to_fp 8 24) #x3ff7ae14)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             ((_ to_fp 8 24) agent0_angle_ackermann!6))
                           ((_ to_fp 11 53) #x40091eb851eb851f))
                   ((_ to_fp 11 53) #x4066800000000000))))
  (fp.leq ((_ to_fp 8 24) roundNearestTiesToEven a!1)
          ((_ to_fp 8 24) #x43070000))))
(assert (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
        (fp.add roundNearestTiesToEven
                ((_ to_fp 8 24) agent1_pos_x_ackermann!20)
                ((_ to_fp 8 24) agent1_lookahead_ackermann!2))))
(assert (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!20) ((_ to_fp 8 24) #x3f7d70a3)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(assert (fp.geq ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
        ((_ to_fp 8 24) agent1_pos_x_ackermann!20)))
(assert (fp.geq ((_ to_fp 8 24) agent0_pos_x_ackermann!4)
        (fp.sub roundNearestTiesToEven
                (fp.sub roundNearestTiesToEven
                        ...
                        ((_ to_fp 8 24) agent1_lookahead_ackermann!2))
                ((_ to_fp 8 24) #x3e3851ec))))
(assert (fp.geq ((_ to_fp 8 24) agent0_pos_z_ackermann!5)
        ((_ to_fp 8 24) agent1_pos_x_ackermann!20)))
(assert (let ((a!1 (ite (= #x00000001 agent1_signal_choice_ackermann!3)
                #x01
                (ite (= #x00000000 agent1_signal_choice_ackermann!3) #x01 #x00)))
      (a!3 (= ((_ extract 0 0)
                (ite (= #x00000001 agent1_signal_choice_ackermann!3) #x01 #x00))
              #b1)))
(let ((a!2 (= ((_ extract 0 0)
                (ite (= #x00000002 agent1_signal_choice_ackermann!3) #x01 a!1))
              #b1)))
(let ((a!4 (and a!2
                (or (= #x00000002 agent1_signal_choice_ackermann!3)
                    (= #x00000001 agent1_signal_choice_ackermann!3))
                (not (= ((_ extract 0 0) a!1) #b1))
                (not a!3))))
  (or (= #x00000000 agent1_signal_choice_ackermann!3)
      (and a!2
           a!3
...
(assert (let ((a!1 (store (store (store (store const_arr10 #x00000000 #x2a)
      ...
      (a!2049 (= ((_ extract 0 0)
                   (ite (= #x00000001 agent1_signal_choice_ackermann!3)
                        #x01
                        #x00))
                 #b1)))
(let ((a!2 (store (store (store (store a!1 #x00000004 #xfc) #x00000005 #xff)
                  ...
                  #x00000007
                  #x41))
      (a!2050 (or (= #x00000000 agent1_signal_choice_ackermann!3)
                  (and a!2049
                       (or (= #x00000002 agent1_signal_choice_ackermann!3)
                           (= #x00000001 agent1_signal_choice_ackermann!3))))))
(let ((a!3 (store (store (store (store a!2 #x00000008 #x00) #x00000009 #x00)
                  ...
                  #x0000000b
                  #x00))
      (a!2051 (ite (= ((_ extract 0 0) (ite a!2050 #x00 #x01)) #b1)
                   #x000001ca
                   #x000001c8)))
(let ((a!4 (store (store (store (store a!3 #x0000000c #x00) #x0000000d #x00)
                  ...
                  #x0000000f
                  #x00))
      (a!2052 ((_ extract 31 0)
                (bvadd #x0000000000000004
                       (bvmul #x0000000000000008 ((_ sign_extend 32) a!2051)))))
      (a!2055 (bvadd #x00000003
                     ((_ extract 31 0)
                       (bvmul #x0000000000000008 ((_ sign_extend 32) a!2051)))))
      (a!2056 (bvadd #x00000002
                     ((_ extract 31 0)
                       (bvmul #x0000000000000008 ((_ sign_extend 32) a!2051)))))
      (a!2057 (bvadd #x00000001
                     ((_ extract 31 0)
                       (bvmul #x0000000000000008 ((_ sign_extend 32) a!2051))))))
...
(let ((a!2048 (store (store (store (store a!2047 #x00001ffc #x00)
                     ...
                     #x00001fff
                     #x00)))
(let ((a!2053 (concat (select a!2048 (bvadd #x00000002 a!2052))
                      (concat (select a!2048 (bvadd #x00000001 a!2052))
                              (select a!2048 a!2052))))
      (a!2058 (select a!2048
                      ((_ extract 31 0)
                        (bvmul #x0000000000000008 ((_ sign_extend 32) a!2051))))))
(let ((a!2054 ((_ to_fp 8 24)
                (concat (select a!2048 (bvadd #x00000003 a!2052)) a!2053)))
      (a!2059 (concat (select a!2048 a!2055)
                      (concat (select a!2048 a!2056)
                              (concat (select a!2048 a!2057) a!2058)))))
(let ((a!2060 ((_ extract 0 0)
                (ite (fp.geq a!2054 ((_ to_fp 8 24) a!2059)) #x01 #x00))))
  (= (ite (= a!2060 #b1) #x00000001 #x00000000)
     (ite (= ((_ extract 0 0) __soid__will_proceed_ackermann!17) #b1)
          #x00000001
          #x00000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
