...
(declare-fun agent1_patience_ackermann!17 () (_ BitVec 32))
(declare-fun agent1_step_count_ackermann!22 () (_ BitVec 32))
(declare-fun agent1_signal_choice_ackermann!18 () (_ BitVec 32))
(declare-fun __soid__will_proceed_ackermann!24 () (_ BitVec 8))
...
(assert (= #x00000000 agent1_patience_ackermann!17))
(assert (= #x0000006d agent1_step_count_ackermann!22))
(assert (or (= #x00000002 agent1_signal_choice_ackermann!18)
    (= #x00000001 agent1_signal_choice_ackermann!18)))
...
(assert (= ((_ extract 0 0)
     (ite (= #x00000001 agent1_signal_choice_ackermann!18) #x01 #x00))
   #b1))
(assert (let ((a!1 (ite (= #x00000002 agent1_signal_choice_ackermann!18)
                #x01
                (ite (= #x00000001 agent1_signal_choice_ackermann!18)
                     #x01
                     (ite (= #x00000000 agent1_signal_choice_ackermann!18)
                          #x01
                          #x00)))))
...
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!3)
             (fp.sub roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
                     ((_ to_fp 8 24) #x3e3851ec)))))
(assert (not (= ((_ extract 0 0) __soid__will_proceed_ackermann!24) #b1)))
(check-sat)
(exit)
