...
(declare-fun agent1_pos_z_ackermann!19 () (_ BitVec 32))
(declare-fun agent1_angle_ackermann!17 () (_ BitVec 32))
(declare-fun agent1_forward_step_ackermann!20 () (_ BitVec 32))
(declare-fun agent1_speed_ackermann!24 () (_ BitVec 32))
(declare-fun agent1_turn_choice_ackermann!16 () (_ BitVec 32))
(declare-fun agent1_lookahead_ackermann!21 () (_ BitVec 32))
(declare-fun agent1_intersection_arrival_ackermann!23 () (_ BitVec 32))
(declare-fun agent1_initial_direction_ackermann!1 () (_ BitVec 32))
(declare-fun agent1_patience_ackermann!2 () (_ BitVec 32))
(declare-fun agent1_step_count_ackermann!15 () (_ BitVec 32))
...
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_z_ackermann!19) ((_ to_fp 8 24) #x3fcb020c)))
(assert (fp.eq ((_ to_fp 8 24) agent1_angle_ackermann!17) ((_ to_fp 8 24) #x3c8b4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_forward_step_ackermann!20)
       ((_ to_fp 8 24) #x3ee147ae)))
(assert (fp.eq ((_ to_fp 8 24) agent1_speed_ackermann!24) ((_ to_fp 8 24) #x3e3020c5)))
(assert (= #x00000002 agent1_turn_choice_ackermann!16))
(assert (fp.eq ((_ to_fp 8 24) agent1_lookahead_ackermann!21)
       ((_ to_fp 8 24) #x3f15c28f)))
(assert (= #x0000003c agent1_intersection_arrival_ackermann!23))
(assert (= #x00000002 agent1_initial_direction_ackermann!1))
(assert (= #x00000000 agent1_patience_ackermann!2))
(assert (= #x0000006d agent1_step_count_ackermann!15))
(assert (or (= #x00000002 agent1_signal_choice_ackermann!0)
...
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_x_ackermann!18)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_z_ackermann!19)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!18)
            ((_ to_fp 8 24) #x403b3333))))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_z_ackermann!19)
            ((_ to_fp 8 24) #x403b3333))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
             ...
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
                       roundNearestTiesToEven
                       ((_ to_fp 8 24) agent1_pos_z_ackermann!19))
                     ((_ to_fp 11 53) #x3fe2b851e0000000)))))
  (= #x00000002
     ((_ fp.to_sbv 32)
       roundTowardZero
...
(assert (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!3)
        (fp.add roundNearestTiesToEven
                ((_ to_fp 8 24) agent1_pos_x_ackermann!18)
                ((_ to_fp 8 24) agent1_lookahead_ackermann!21))))
...
(assert (let ((a!1 (= ((_ extract 0 0)
              ...
              #b1)))
  (not a!1)))
(assert (let ((a!1 (ite (= #x00000002 agent1_signal_choice_ackermann!0)
                #x01
                (ite (= #x00000001 agent1_signal_choice_ackermann!0)
                     #x01
                     (ite (= #x00000000 agent1_signal_choice_ackermann!0)
                          #x01
                          #x00)))))
...
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!3)
             (fp.sub roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!18)
                     ((_ to_fp 8 24) #x3e3851ec)))))
(assert (= ((_ extract 0 0) __soid__will_proceed_ackermann!22) #b1))
(check-sat)
(exit)
