...
int main(int argc, char **argv) {
   ...
   model[1023][1] = 0.0;
    ...
    klee_assume( agent0_pos_z == (float) 1.84 ); // Concrete Val 
    klee_assume( agent0_angle == (float) 1.571 ); // Concrete Val 
    klee_assume( agent0_forward_step == (float) 0.44 ); // Concrete Val 
    klee_assume( agent0_speed == (float) 0.049 ); // Concrete Val 
    ...
    klee_assume( agent0_intersection_arrival == 78); // Concrete State Val 
    klee_assume( agent0_initial_direction == 0); // Concrete State Val 
    klee_assume( agent0_patience == 0); // Concrete State Val 
    klee_assume( agent0_step_count == 92); // Concrete State Val 
    ...
    klee_assume( agent1_pos_x == (float) 1.086 ); // Concrete Val 
    ...
    klee_assume( agent1_speed == (float) 0.002 ); // Concrete Val 
    ...
    klee_assume( agent1_step_count == 92); // Concrete State Val 
