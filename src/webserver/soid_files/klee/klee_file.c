...
int main(int argc, char **argv) {
   ...
   model[1023][1] = 0.0;
    ...
    klee_assume( agent0_step_count == 110); // Concrete State Val 
    ...
    klee_assume( agent1_pos_x == (float) 1.159 ); // Concrete Val 
    ...
    klee_assume( agent1_speed == (float) 0.174 ); // Concrete Val 
    ...
    klee_assume( agent1_step_count == 110); // Concrete State Val 
