...
int main(int argc, char **argv) {
   ...
   model[1023][1] = 0.0;
    ...
    klee_assume( agent0_pos_x == (float) 1.589 ); // Concrete Val 
    klee_assume( agent0_pos_z == (float) 2.226 ); // Concrete Val 
    klee_assume( agent0_angle == (float) 1.581 ); // Concrete Val 
    klee_assume( agent0_forward_step == (float) 0.44 ); // Concrete Val 
    klee_assume( agent0_speed == (float) 0.298 ); // Concrete Val 
    ...
    klee_assume( agent0_intersection_arrival == -1); // Concrete State Val 
    klee_assume( agent0_initial_direction == 0); // Concrete State Val 
    klee_assume( agent0_patience == 0); // Concrete State Val 
    klee_assume( agent0_step_count == 48); // Concrete State Val 
    ...
    klee_assume( agent1_pos_x == (float) 0.874 ); // Concrete Val 
    klee_assume( agent1_pos_z == (float) 1.589 ); // Concrete Val 
    klee_assume( agent1_angle == (float) 0.01 ); // Concrete Val 
    klee_assume( agent1_forward_step == (float) 0.44 ); // Concrete Val 
    klee_assume( agent1_speed == (float) 0.298 ); // Concrete Val 
    klee_assume( agent1_signal_choice == RIGHT ); // Concrete Val 
    klee_assume( agent1_turn_choice == RIGHT ); // Concrete Val 
    klee_assume( agent1_lookahead == (float) 0.585); // Concrete State Val 
    klee_assume( agent1_intersection_arrival == -1); // Concrete State Val 
    klee_assume( agent1_initial_direction == 2); // Concrete State Val 
    klee_assume( agent1_patience == 0); // Concrete State Val 
    klee_assume( agent1_step_count == 48); // Concrete State Val 
