...
(declare-fun agent1_pos_z_ackermann!14 () (_ BitVec 32))
(declare-fun agent0_turn_choice_ackermann!9 () (_ BitVec 32))
(declare-fun agent1_intersection_arrival_ackermann!20 () (_ BitVec 32))
(declare-fun agent1_pos_x_ackermann!21 () (_ BitVec 32))
(declare-fun agent0_pos_x_ackermann!2 () (_ BitVec 32))
(declare-fun agent1_step_count_ackermann!22 () (_ BitVec 32))
...
(declare-fun agent1_angle_ackermann!18 () (_ BitVec 32))
(declare-fun agent1_initial_direction_ackermann!1 () (_ BitVec 32))
...
(declare-fun agent1_speed_ackermann!15 () (_ BitVec 32))
(declare-fun agent0_angle_ackermann!4 () (_ BitVec 32))
(declare-fun agent1_signal_choice_ackermann!17 () (_ BitVec 32))
(assert (= #x00000000 agent0_patience_ackermann!12))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_z_ackermann!14)
            ((_ to_fp 8 24) #x403b3333))))
(assert (= #x00000002 agent0_turn_choice_ackermann!9))
(assert (= #x0000003c agent1_intersection_arrival_ackermann!20))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_z_ackermann!14)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
             (fp.sub roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
                     ((_ to_fp 8 24) #x3e3851ec)))))
(assert (= #x0000006d agent1_step_count_ackermann!22))
...
(assert (let ((a!1 ((_ to_fp 8 24)
  ...
  (not (fp.geq ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
               (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             ((_ to_fp 8 24) agent1_angle_ackermann!18))
...
(assert (not (fp.lt ((_ to_fp 8 24) agent0_pos_z_ackermann!3)
            ((_ to_fp 8 24) #x00000000))))
(assert (= #x00000002 agent1_initial_direction_ackermann!1))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!2 (ite (and (fp.gt ((_ to_fp 8 24) roundNearestTiesToEven a!1)
                ...
                #x00000002)))
  (= #x00000002 a!2))))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
            ((_ to_fp 8 24) #x00000000))))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (fp.div roundNearestTiesToEven
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
             ...
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
                       roundNearestTiesToEven
                       ((_ to_fp 8 24) agent1_pos_z_ackermann!14))
                     ((_ to_fp 11 53) #x3fe2b851e0000000)))))
  (= #x00000002
     ((_ fp.to_sbv 32)
       roundTowardZero
...
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
            ((_ to_fp 8 24) #x403b3333))))
(assert (= #x00000000 agent0_initial_direction_ackermann!10))
(assert (not (fp.gt ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
            ((_ to_fp 8 24) #x403b3333))))
(assert (fp.eq ((_ to_fp 8 24) agent1_angle_ackermann!18) ((_ to_fp 8 24) #x3c8b4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_x_ackermann!21) ((_ to_fp 8 24) #x3f939581)))
...
(assert (fp.eq ((_ to_fp 8 24) agent1_speed_ackermann!15) ((_ to_fp 8 24) #x3e3020c5)))
(assert (fp.eq ((_ to_fp 8 24) agent0_angle_ackermann!4) ((_ to_fp 8 24) #x3fcb4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_z_ackermann!14) ((_ to_fp 8 24) #x3fcb020c)))
...
(assert (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
        (fp.add roundNearestTiesToEven
                ((_ to_fp 8 24) agent1_pos_x_ackermann!21)
                ((_ to_fp 8 24) agent1_lookahead_ackermann!23))))
(assert (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!21) ((_ to_fp 8 24) #x3f7d70a3)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(assert (fp.geq ((_ to_fp 8 24) agent0_pos_z_ackermann!3)
        ((_ to_fp 8 24) agent1_pos_x_ackermann!21)))
(assert (let ((a!1 (ite (= #x00000001 agent1_signal_choice_ackermann!17)
                #x01
                (ite (= #x00000000 agent1_signal_choice_ackermann!17) #x01 #x00)))
      (a!3 (= ((_ extract 0 0)
                (ite (= #x00000001 agent1_signal_choice_ackermann!17) #x01 #x00))
              #b1)))
(let ((a!2 (= ((_ extract 0 0)
                (ite (= #x00000002 agent1_signal_choice_ackermann!17) #x01 a!1))
              #b1)))
(let ((a!4 (and a!2
                (or (= #x00000002 agent1_signal_choice_ackermann!17)
                    (= #x00000001 agent1_signal_choice_ackermann!17))
                (not (= ((_ extract 0 0) a!1) #b1))
                (not a!3))))
  (or (= #x00000000 agent1_signal_choice_ackermann!17)
      (and a!2
           a!3
