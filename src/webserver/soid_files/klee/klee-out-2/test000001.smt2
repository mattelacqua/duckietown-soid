(set-logic ALL)
(declare-fun __soid__agent0_state_cars_waiting_to_enter_ackermann!28
             ()
             (_ BitVec 8))
(declare-fun __soid__agent0_state_at_intersection_entry_ackermann!57
             ()
             (_ BitVec 8))
(declare-fun __soid__agent1_state_safe_to_enter_ackermann!41 () (_ BitVec 8))
(declare-fun __soid__agent1_state_intersection_empty_ackermann!60
             ()
             (_ BitVec 8))
(declare-fun __soid__agent1_state_cars_waiting_to_enter_ackermann!22
             ()
             (_ BitVec 8))
(declare-fun __soid__agent1_state_has_right_of_way_ackermann!52 () (_ BitVec 8))
(declare-fun __soid__agent1_state_at_intersection_entry_ackermann!58
             ()
             (_ BitVec 8))
(declare-fun __soid__agent0_state_intersection_empty_ackermann!55
             ()
             (_ BitVec 8))
(declare-fun __soid__agent0_state_approaching_intersection_ackermann!26
             ()
             (_ BitVec 8))
(declare-fun __soid__agent1_state_approaching_intersection_ackermann!56
             ()
             (_ BitVec 8))
(declare-fun __soid__agent0_direction_ackermann!35 () (_ BitVec 32))
(declare-fun __soid__agent0_tile_x_ackermann!40 () (_ BitVec 32))
(declare-fun __soid__agent1_state_is_tailgating_ackermann!23 () (_ BitVec 8))
(declare-fun __soid__agent1_state_car_entering_range_ackermann!51
             ()
             (_ BitVec 8))
(declare-fun agent0_patience_ackermann!12 () (_ BitVec 32))
(declare-fun __soid__agent1_state_obj_in_range_ackermann!59 () (_ BitVec 8))
(declare-fun agent1_pos_z_ackermann!36 () (_ BitVec 32))
(declare-fun __soid__agent1_state_in_intersection_ackermann!21 () (_ BitVec 8))
(declare-fun __soid__agent1_tile_x_ackermann!34 () (_ BitVec 32))
(declare-fun agent0_turn_choice_ackermann!9 () (_ BitVec 32))
(declare-fun __soid__agent0_state_car_entering_range_ackermann!20
             ()
             (_ BitVec 8))
(declare-fun agent1_intersection_arrival_ackermann!17 () (_ BitVec 32))
(declare-fun __soid__agent1_direction_ackermann!30 () (_ BitVec 32))
(declare-fun __soid__agent0_state_in_intersection_ackermann!25 () (_ BitVec 8))
(declare-fun agent1_pos_x_ackermann!27 () (_ BitVec 32))
(declare-fun agent0_pos_x_ackermann!2 () (_ BitVec 32))
(declare-fun agent1_step_count_ackermann!43 () (_ BitVec 32))
(declare-fun __soid__agent0_state_obj_in_range_ackermann!32 () (_ BitVec 8))
(declare-fun agent1_patience_ackermann!45 () (_ BitVec 32))
...
(declare-fun agent1_angle_ackermann!44 () (_ BitVec 32))
(declare-fun __soid__agent0_state_is_tailgating_ackermann!48 () (_ BitVec 8))
(declare-fun __soid__agent0_tile_z_ackermann!38 () (_ BitVec 32))
(declare-fun agent1_initial_direction_ackermann!46 () (_ BitVec 32))
(declare-fun __soid__agent1_state_next_to_go_ackermann!19 () (_ BitVec 8))
(declare-fun __soid__agent1_tile_z_ackermann!37 () (_ BitVec 32))
(declare-fun agent0_intersection_arrival_ackermann!11 () (_ BitVec 32))
(declare-fun __soid__agent0_state_has_right_of_way_ackermann!18 () (_ BitVec 8))
(declare-fun __soid__agent1_state_obj_behind_intersection_ackermann!42
             ()
             (_ BitVec 8))
...
(declare-fun __soid__agent1_stop_x_ackermann!29 () (_ BitVec 32))
...
(declare-fun __soid__agent0_stop_x_ackermann!39 () (_ BitVec 32))
(declare-fun __soid__agent0_stop_z_ackermann!50 () (_ BitVec 32))
(declare-fun agent0_angle_ackermann!4 () (_ BitVec 32))
(declare-fun __soid__agent1_stop_z_ackermann!47 () (_ BitVec 32))
(declare-fun __soid__agent1_prev_pos_x_ackermann!16 () (_ BitVec 32))
(declare-fun agent1_signal_choice_ackermann!1 () (_ BitVec 32))
(declare-fun __soid__agent0_state_safe_to_enter_ackermann!54 () (_ BitVec 8))
(declare-fun __soid__mrow__ackermann!53 () (_ BitVec 32))
(declare-fun __soid__will_proceed_ackermann!61 () (_ BitVec 8))
(declare-fun const_arr10 () (Array (_ BitVec 32) (_ BitVec 8)))
(assert (= ((_ extract 0 0) __soid__agent0_state_cars_waiting_to_enter_ackermann!28)
   #b1))
(assert (= ((_ extract 0 0) __soid__agent0_state_at_intersection_entry_ackermann!57)
   #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_safe_to_enter_ackermann!41) #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_intersection_empty_ackermann!60) #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_cars_waiting_to_enter_ackermann!22)
   #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_has_right_of_way_ackermann!52) #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_at_intersection_entry_ackermann!58)
   #b1))
(assert (= ((_ extract 0 0) __soid__agent0_state_intersection_empty_ackermann!55) #b1))
(assert (= ((_ extract 0 0) __soid__agent0_state_approaching_intersection_ackermann!26)
   #b1))
(assert (= ((_ extract 0 0) __soid__agent1_state_approaching_intersection_ackermann!56)
   #b1))
(assert (= #x00000000 __soid__agent0_direction_ackermann!35))
(assert (= #x00000002 __soid__agent0_tile_x_ackermann!40))
(assert (not (= ((_ extract 0 0) __soid__agent1_state_is_tailgating_ackermann!23) #b1)))
(assert (not (= ((_ extract 0 0) __soid__agent1_state_car_entering_range_ackermann!51)
        #b1)))
(assert (= #x00000000 agent0_patience_ackermann!12))
(assert (not (= ((_ extract 0 0) __soid__agent1_state_obj_in_range_ackermann!59) #b1)))
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_z_ackermann!36)
            ((_ to_fp 8 24) #x403b3333))))
(assert (not (= ((_ extract 0 0) __soid__agent1_state_in_intersection_ackermann!21) #b1)))
(assert (= #x00000001 __soid__agent1_tile_x_ackermann!34))
(assert (= #x00000002 agent0_turn_choice_ackermann!9))
(assert (not (= ((_ extract 0 0) __soid__agent0_state_car_entering_range_ackermann!20)
        #b1)))
(assert (= #x0000003c agent1_intersection_arrival_ackermann!17))
(assert (= #x00000002 __soid__agent1_direction_ackermann!30))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_z_ackermann!36)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (= ((_ extract 0 0) __soid__agent0_state_in_intersection_ackermann!25) #b1)))
(assert (not (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
             (fp.sub roundNearestTiesToEven
                     ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
                     ((_ to_fp 8 24) #x3e3851ec)))))
(assert (= #x0000006d agent1_step_count_ackermann!43))
(assert (not (= ((_ extract 0 0) __soid__agent0_state_obj_in_range_ackermann!32) #b1)))
(assert (= #x00000000 agent1_patience_ackermann!45))
(assert (let ((a!1 ((_ to_fp 8 24)
  ...
  (not (fp.geq ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
               (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             ((_ to_fp 8 24) agent1_angle_ackermann!44))
...
(assert (not (= ((_ extract 0 0) __soid__agent0_state_is_tailgating_ackermann!48) #b1)))
...
(assert (not (fp.lt ((_ to_fp 8 24) agent0_pos_z_ackermann!3)
            ((_ to_fp 8 24) #x00000000))))
(assert (= #x00000002 agent1_initial_direction_ackermann!46))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!2 (ite (and (fp.gt ((_ to_fp 8 24) roundNearestTiesToEven a!1)
                ...
                #x00000002)))
  (= #x00000002 a!2))))
(assert (not (fp.lt ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
            ((_ to_fp 8 24) #x00000000))))
(assert (not (= ((_ extract 0 0) __soid__agent1_state_next_to_go_ackermann!19) #b1)))
(assert (= #x00000002 __soid__agent1_tile_z_ackermann!37))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53)
...
(assert (not (= ((_ extract 0 0) __soid__agent0_state_has_right_of_way_ackermann!18)
        #b1)))
(assert (not (= ((_ extract 0 0)
          __soid__agent1_state_obj_behind_intersection_ackermann!42)
        #b1)))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (fp.div roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
            ((_ to_fp 8 24) #x403b3333))))
...
(assert (not (fp.gt ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
            ((_ to_fp 8 24) #x403b3333))))
(assert (fp.eq ((_ to_fp 8 24) agent1_angle_ackermann!44) ((_ to_fp 8 24) #x3c8b4396)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_x_ackermann!27) ((_ to_fp 8 24) #x3f939581)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 8 24) a!1)
                                   ((_ to_fp 8 24) #x3f15c28f))))))
  (fp.eq a!2 ((_ to_fp 8 24) __soid__agent1_stop_x_ackermann!29)))))
...
(assert (fp.eq ((_ to_fp 8 24) #x3f60a3d6)
       ((_ to_fp 8 24) __soid__agent0_stop_x_ackermann!39)))
(assert (let ((a!1 (ite (fp.gt ((_ to_fp 11 53)
                         roundNearestTiesToEven
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 8 24) a!1)
                                   ((_ to_fp 8 24) #x3f15c28f))))))
  (fp.eq a!2 ((_ to_fp 8 24) __soid__agent0_stop_z_ackermann!50)))))
...
(assert (fp.eq ((_ to_fp 8 24) #x3fbb3333)
       ((_ to_fp 8 24) __soid__agent1_stop_z_ackermann!47)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_z_ackermann!36) ((_ to_fp 8 24) #x3fcb020c)))
(assert (fp.eq ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
       ((_ to_fp 8 24) __soid__agent1_prev_pos_x_ackermann!16)))
...
(assert (fp.leq ((_ to_fp 8 24) agent0_pos_x_ackermann!2)
        (fp.add roundNearestTiesToEven
                ((_ to_fp 8 24) agent1_pos_x_ackermann!27)
                ((_ to_fp 8 24) agent1_lookahead_ackermann!24))))
(assert (fp.gt ((_ to_fp 8 24) agent1_pos_x_ackermann!27) ((_ to_fp 8 24) #x3f7d70a3)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!4 (or (= #x00000000 agent1_signal_choice_ackermann!1)
      ...
      (a!6 (and a!2
                (= ((_ extract 0 0)
                     __soid__agent0_state_safe_to_enter_ackermann!54)
                   #b1)
                (or (= #x00000002 agent1_signal_choice_ackermann!1)
                    (= #x00000001 agent1_signal_choice_ackermann!1))
...
(let ((a!4 (ite (= ((_ extract 0 0) (ite a!3 #x00 #x01)) #b1)
                #x000001ca
                #x000001c8)))
  (= a!4 __soid__mrow__ackermann!53))))))
...
(let ((a!2061 ((_ extract 0 0)
  ...
  (= (ite (= a!2061 #b1) #x00000001 #x00000000)
     (ite (= ((_ extract 0 0) __soid__will_proceed_ackermann!61) #b1)
          #x00000001
          #x00000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
