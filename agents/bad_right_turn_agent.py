...
# make a terrible right turn
def bad_right_turn(env, forward_step):
    ...
    # Turn this amount 
    while turn_count < 24:          # Arbitrary turn count that works for speed limit?
...
def update():
    ...
    if move.intersection_detected(env):
        return bad_right_turn(env, forward_step)
